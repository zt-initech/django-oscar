...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductAttribute.product_class'
        db.delete_column(u'catalogue_productattribute', 'product_class_id')

        # Adding M2M table for field attributes on 'ProductClass'
        db.create_table(u'catalogue_productclass_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productclass', models.ForeignKey(orm[u'catalogue.productclass'], null=False)),
            ('productattribute', models.ForeignKey(orm[u'catalogue.productattribute'], null=False))
        ))
        db.create_unique(u'catalogue_productclass_attributes', ['productclass_id', 'productattribute_id'])


    def backwards(self, orm):
        # Adding field 'ProductAttribute.product_class'
        db.add_column(u'catalogue_productattribute', 'product_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='attributes', null=True, to=orm['catalogue.ProductClass'], blank=True),
                      keep_default=False)

        # Removing M2M table for field attributes on 'ProductClass'
        db.delete_table('catalogue_productclass_attributes')
    ...
    models = {
        ...
        u'catalogue.productclass': {
            ...
            'attributes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'product_classes'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['catalogue.ProductAttribute']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
