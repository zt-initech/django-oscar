...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_featuredproduct', (
            ...
            ('render_template', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'plugins', ['FeaturedProduct'])


    def backwards(self, orm):
        # Deleting model 'FeaturedProduct'
        db.delete_table(u'cmsplugin_featuredproduct')
    ...
    models = {
        ...
        u'plugins.featuredproduct': {
            'Meta': {'object_name': 'FeaturedProduct', 'db_table': "u'cmsplugin_featuredproduct'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']"}),
            'render_template': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
