        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    ...
                    max_length=128,
                    verbose_name='Status',
                    choices=[('Open', 'Open - currently active'), (
                ...
                ('date_merged', models.DateTimeField(blank=True,
                                                     verbose_name='Date merged',
                                                     null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        ...
                                        serialize=False,
                                        verbose_name='ID')),
                ('line_reference', models.SlugField(max_length=128,
                                                    verbose_name='Line Reference')),
                ('quantity', models.PositiveIntegerField(default=1,
                                                         verbose_name='Quantity')),
                ('price_currency', models.CharField(default='GBP',
                                                    max_length=12,
                                                    verbose_name='Currency')),
                ('price_excl_tax', models.DecimalField(max_digits=12,
                                                       decimal_places=2,
                                                       verbose_name='Price excl. Tax',
                                                       null=True)),
                ('price_incl_tax', models.DecimalField(max_digits=12,
                                                       decimal_places=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=255,
                                           verbose_name='Value')),
                ('line', models.ForeignKey(verbose_name='Line',
