...
class CheckoutApplication(Application):
    ...
    user_address_update_view = get_class('checkout.views', 'UserAddressUpdateView')
    user_address_delete_view = get_class('checkout.views', 'UserAddressDeleteView')
    ...
    def get_urls(self):
        urls = [
            ...
            url(r'shipping-address/$', self.shipping_address_view.as_view(),
            ...
            url(r'shipping-method/$', self.shipping_method_view.as_view(),
            ...
            url(r'preview/$', self.payment_details_view.as_view(preview=True),
                name='preview'),
