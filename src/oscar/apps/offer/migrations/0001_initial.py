    ...
    operations = [migrations.CreateModel(
        ...
        [('id', models.AutoField(auto_created=True,
         ...
         ('type', models.CharField(
             ...
             max_length=128,
             blank=True,
             choices=[('Percentage', "Discount is a percentage off of the product's value"), (
                 'Absolute', "Discount is a fixed amount off of the product's value"
             ), ('Multibuy', 'Discount is to give the cheapest product for free'), (
                 'Fixed price', 'Get the products that meet the condition for a fixed price'
             ), ('Shipping absolute', 'Discount is a fixed amount of the shipping cost'), (
                 'Shipping fixed price', 'Get shipping for a fixed price'
             ), ('Shipping percentage', 'Discount is a percentage off of the shipping cost')])),
         ('value', oscar.models.fields.PositiveDecimalField(max_digits=12,
                                                            decimal_places=2,
                                                            blank=True,
                                                            verbose_name='Value',
                                                            null=True)),
         ('max_affected_items', models.PositiveIntegerField(
             ...
             null=True)),
         ('proxy_class', oscar.models.fields.NullCharField(unique=True,
        ...
        bases=(models.Model, ), ),
                  migrations.CreateModel(
                      ...
                      [('id', models.AutoField(auto_created=True,
                       ...
                       ('value', oscar.models.fields.PositiveDecimalField(max_digits=12,
                                                                          ...
                                                                          null=True)),
                       ('proxy_class',
                        oscar.models.fields.NullCharField(unique=True,
                                                          verbose_name='Custom class',
                                                          default=None,
                                                          max_length=255)), ],
                      options=
                  ...
                  migrations.CreateModel(
                      ...
                      [('id', models.AutoField(auto_created=True,
                       ...
                       ('slug', oscar.models.fields.autoslugfield.AutoSlugField(populate_from
                                                                                ='name',
                                                                                unique
                                                                                =True,
                                                                                verbose_name='Slug',
                       ...
                       ('max_discount', models.DecimalField(
                           ...
                           blank=True)),
                       ('total_discount', models.DecimalField(default=Decimal('0.00'),
                                                              max_digits=12,
                                                              decimal_places=2,
                       ...
                       ('redirect_url', oscar.models.fields.ExtendedURLField(
                           verbose_name='URL redirect (optional)',
                           blank=True)),
                       ('date_created', models.DateTimeField(auto_now_add=True,
                                                             verbose_name='Date Created')),
                       ('benefit', models.ForeignKey(verbose_name='Benefit',
                                                     to='offer.Benefit')),
                       ('condition', models.ForeignKey(verbose_name='Condition',
                                                       to='offer.Condition')), ],
                      options={
                          'ordering': ['-priority'],
                  ...
                  migrations.CreateModel(
                      ...
                      fields=[('id', models.AutoField(auto_created=True,
                              ...
                              ('name', models.CharField(unique=True,
                                                        max_length=128,
                                                        verbose_name='Name')),
                              ('slug', oscar.models.fields.autoslugfield.AutoSlugField(
                                  populate_from='name',
                                  unique=True,
                                  verbose_name='Slug',
                                  max_length=128,
                              ...
                              ('date_created', models.DateTimeField(auto_now_add=True,
                                                                    verbose_name='Date Created')),
                              ('classes', models.ManyToManyField(related_name='classes',
                                                                 verbose_name='Product Types',
                                                                 to='catalogue.ProductClass',
                                                                 blank=True)),
                              ('excluded_products',
                               models.ManyToManyField(related_name='excludes',
                                                      verbose_name='Excluded Products',
                                                      to='catalogue.Product',
                                                      blank=True)),
                              ('included_categories',
                               models.ManyToManyField(related_name='includes',
                  ...
                  migrations.CreateModel(
                      ...
                      fields=[('id', models.AutoField(auto_created=True,
                              ...
                              ('error_message', models.CharField(max_length=255,
                                                                 ...
                                                                 blank=True)),
                              ('date_processed', models.DateTimeField(verbose_name='Date Processed',
                                                                      null=True)),
                              ('num_new_skus',
                               models.PositiveIntegerField(verbose_name='Number of New SKUs',
                                                           null=True)),
                              ('num_unknown_skus',
                               models.PositiveIntegerField(verbose_name='Number of Unknown SKUs',
                                                           null=True)),
                              ('num_duplicate_skus',
                               models.PositiveIntegerField(verbose_name='Number of Duplicate SKUs',
                                                           null=True)),
                              ('range', models.ForeignKey(verbose_name='Range',
                                                          related_name='file_uploads',
                                                          to='offer.Range')),
                              ('uploaded_by', models.ForeignKey(verbose_name='Uploaded By',
                      ...
                      bases=(models.Model, ), ),
                  migrations.AlterUniqueTogether(name='rangeproduct',
                                                 unique_together=set([('range', 'product')]), ),
                  migrations.AddField(
                      model_name='range',
                      name='included_products',
                      field=models.ManyToManyField(related_name='includes',
                                                   verbose_name='Included Products',
                                                   to='catalogue.Product',
                                                   through='offer.RangeProduct',
                                                   blank=True),
                      preserve_default=True, ),
                  migrations.AddField(model_name='condition',
                                      name='range',
                                      field=models.ForeignKey(null=True,
                                                              ...
                                                              blank=True),
                                      preserve_default=True, ),
                  migrations.AddField(model_name='benefit',
                                      name='range',
                                      field=models.ForeignKey(null=True,
                                                              verbose_name='Range',
                                                              to='offer.Range',
                                                              blank=True),
                                      preserve_default=True, ),
                  migrations.CreateModel(name='AbsoluteDiscountBenefit',
                                         fields=[],
                                         options={
                                         ...
                                         bases=('offer.benefit', ), ),
                  migrations.CreateModel(name='CountCondition',
                                         fields=[],
                                         options={
                  ...
                  migrations.CreateModel(name='CoverageCondition',
                                         fields=[],
                                         options={
                                         ...
                                         bases=('offer.condition', ), ),
                  migrations.CreateModel(name='FixedPriceBenefit',
                                         fields=[],
                                         options={
                                         ...
                                         bases=('offer.benefit', ), ),
                  migrations.CreateModel(name='MultibuyDiscountBenefit',
                                         fields=[],
                                         options={
                                         ...
                                         bases=('offer.benefit', ), ),
                  migrations.CreateModel(name='PercentageDiscountBenefit',
                                         fields=[],
                                         options={
                                         ...
                                         bases=('offer.benefit', ), ),
                  migrations.CreateModel(name='ShippingBenefit',
                                         fields=[],
                                         options={'proxy': True, },
                                         bases=('offer.benefit', ), ),
                  migrations.CreateModel(
                  ...
                  migrations.CreateModel(
                      ...
                      bases=('offer.shippingbenefit', ), ),
                  migrations.CreateModel(name='ValueCondition',
                                         fields=[],
                                         options={
