    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True,
                                                      verbose_name='Date')),
                ('event_type', models.ForeignKey(verbose_name='Event Type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_line_reference', models.CharField(
                    ...
                    blank=True)),
                ('partner_line_notes', models.TextField(verbose_name='Partner Notes',
                                                        blank=True)),
                ...
                ('line_price_incl_tax', models.DecimalField(max_digits=12,
                                                            decimal_places=2,
                                                            verbose_name='Price (inc. tax)')),
                ('line_price_excl_tax', models.DecimalField(max_digits=12,
                                                            decimal_places=2,
                ...
                ('unit_cost_price', models.DecimalField(max_digits=12,
                                                        decimal_places=2,
                                                        blank=True,
                                                        verbose_name='Unit Cost Price',
                                                        null=True)),
                ('unit_price_incl_tax', models.DecimalField(max_digits=12,
                                                            decimal_places=2,
                                                            blank=True,
                                                            verbose_name='Unit Price (inc. tax)',
                                                            null=True)),
                ('unit_price_excl_tax', models.DecimalField(max_digits=12,
                                                            decimal_places=2,
                                                            blank=True,
                                                            verbose_name='Unit Price (excl. tax)',
                                                            null=True)),
                ('unit_retail_price', models.DecimalField(max_digits=12,
                                                          decimal_places=2,
                                                          blank=True,
                ...
                ('status', models.CharField(max_length=255,
                                            verbose_name='Status',
                                            blank=True)),
                ('est_dispatch_date', models.DateField(blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_excl_tax', models.DecimalField(max_digits=12,
                                                       decimal_places=2,
                                                       verbose_name='Price (excl. tax)')),
                ('shipping_incl_tax', models.DecimalField(default=0,
                                                          max_digits=12,
                                                          decimal_places=2,
                                                          verbose_name='Shiping (inc. tax)')),
                ('shipping_excl_tax', models.DecimalField(default=0,
                                                          max_digits=12,
                                                          decimal_places=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_incl_tax', models.DecimalField(max_digits=12,
                                                       decimal_places=2,
                                                       verbose_name='Order total (inc. tax)')),
                ('total_excl_tax', models.DecimalField(max_digits=12,
                                                       decimal_places=2,
                ...
                ('shipping_method', models.CharField(max_length=128,
                                                     ...
                                                     blank=True)),
                ('shipping_code', models.CharField(default='',
                                                   max_length=128,
                                                   blank=True)),
                ('status', models.CharField(max_length=100,
                                            verbose_name='Status',
                                            blank=True)),
                ('guest_email', models.EmailField(max_length=75,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        ...
                                        serialize=False,
                                        verbose_name='ID')),
                ('category', models.CharField(default='Basket',
                                              max_length=64,
                                              verbose_name='Discount category',
                                              choices=[('Basket', 'Basket'), (
                                                  'Shipping', 'Shipping'
                                              ), ('Deferred', 'Deferred')])),
                ('offer_id', models.PositiveIntegerField(blank=True,
                ...
                ('offer_name', models.CharField(max_length=128,
                                                ...
                                                blank=True)),
                ('voucher_id', models.PositiveIntegerField(blank=True,
        ...
        migrations.AddField(
            ...
            name='event_type',
            field=models.ForeignKey(verbose_name='Event Type',
                                    to='order.ShippingEventType'),
            preserve_default=True, ),
        migrations.AddField(
            model_name='shippingevent',
            name='lines',
            field=models.ManyToManyField(related_name='shipping_events',
                                         verbose_name='Lines',
                                         to='order.Line',
        ...
        migrations.AddField(
            model_name='shippingevent',
            name='order',
            field=models.ForeignKey(verbose_name='Order',
        ...
        migrations.AddField(
            model_name='paymentevent',
            name='lines',
            field=models.ManyToManyField(through='order.PaymentEventQuantity',
                                         verbose_name='Lines',
                                         to='order.Line'),
            preserve_default=True, ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='paymentevent',
            name='shipping_event',
            field=models.ForeignKey(related_name='payment_events',
                                    to='order.ShippingEvent',
                                    null=True),
            preserve_default=True, ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='order',
            name='site',
            field=models.ForeignKey(verbose_name='Site',
                                    on_delete=django.db.models.deletion.SET_NULL,
                                    to='sites.Site',
                                    null=True),
            preserve_default=True, ),
