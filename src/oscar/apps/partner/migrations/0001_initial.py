...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128,
                                          verbose_name='Name',
                                          blank=True)),
                ('users', models.ManyToManyField(related_name='partners',
                                                 blank=True,
                                                 verbose_name='Users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(verbose_name='Country',
                                              to='address.Country')),
                ('partner', models.ForeignKey(verbose_name='Partner',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_excl_tax', models.DecimalField(max_digits=12,
                                                       ...
                                                       null=True)),
                ('price_retail', models.DecimalField(max_digits=12,
                                                     decimal_places=2,
                                                     blank=True,
                                                     verbose_name='Price (retail)',
                                                     null=True)),
                ('cost_price', models.DecimalField(max_digits=12,
                                                   decimal_places=2,
                                                   blank=True,
                                                   verbose_name='Cost Price',
                                                   null=True)),
                ('num_in_stock', models.PositiveIntegerField(blank=True,
                                                             verbose_name='Number in stock',
                                                             null=True)),
                ('num_allocated', models.IntegerField(blank=True,
        ...
        migrations.AddField(
            ...
            name='stockrecord',
            field=models.ForeignKey(verbose_name='Stock Record',
                                    related_name='alerts',
