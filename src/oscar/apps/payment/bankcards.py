...
VISA, VISA_ELECTRON, MASTERCARD, AMEX, MAESTRO, DISCOVER = (
    'Visa', 'Visa Electron', 'Mastercard', 'American Express', 'Maestro', 'Discover'
)
...
CARD_TYPES = [
    ...
    (SWITCH, list(range(16, 20)), ('4903', '4905', '4911', '4936', '564182', '633110', '6333',
                                   '6759')),
    (VISA, (13, 16), ('4', )),
