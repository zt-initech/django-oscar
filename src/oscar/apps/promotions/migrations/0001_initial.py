...
class Migration(migrations.Migration):
    ...
    dependencies = [('catalogue', '0001_initial'), ('contenttypes', '0001_initial'), ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Description',
                                                 blank=True)),
                ('link_url', oscar.models.fields.ExtendedURLField(verbose_name='Link URL',
                                                                  blank=True)),
                ...
                ('method', models.CharField(
                    max_length=128,
                    verbose_name='Method',
                    choices=[('Bestselling', 'Bestselling products'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128,
                                          verbose_name='Name')),
                ('link_url', oscar.models.fields.ExtendedURLField(
                    verbose_name='Link URL',
                    help_text='This is where this promotion links to',
                    blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(
                    blank=True,
                    help_text=
                    'Choose the Image content blocks that this block will use. (You may need to create some first).',
                    to='promotions.Image',
                    null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True,
                                                      verbose_name='Date Created')),
                ('page_url', oscar.models.fields.ExtendedURLField(
                    max_length=128,
                    verify_exists=True,
                    db_index=True,
        ...
        migrations.AddField(
            ...
            name='tabbed_block',
            field=models.ForeignKey(verbose_name='Tabbed Block',
                                    related_name='tabs',
                                    to='promotions.TabbedBlock'),
            preserve_default=True, ),
        migrations.AddField(
            model_name='orderedproduct',
            name='list',
            field=models.ForeignKey(verbose_name='List',
                                    to='promotions.HandPickedProductList'),
            preserve_default=True, ),
        migrations.AddField(
            model_name='orderedproduct',
            name='product',
            field=models.ForeignKey(verbose_name='Product',
        ...
        migrations.AddField(
            ...
            name='products',
            field=models.ManyToManyField(through='promotions.OrderedProduct',
                                         blank=True,
