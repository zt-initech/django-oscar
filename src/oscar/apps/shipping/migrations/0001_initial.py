...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Description',
                                                 blank=True)),
                ('price_per_order', models.DecimalField(default=Decimal('0.00'),
                                                        max_digits=12,
                                                        decimal_places=2,
                ...
                ('free_shipping_threshold', models.DecimalField(max_digits=12,
                                                                decimal_places=2,
                                                                blank=True,
            ...
            fields=[
                ...
                ('upper_limit', models.DecimalField(
                    ...
                    validators=[django.core.validators.MinValueValidator(
                        Decimal('0.00'))],
                    help_text=
                    'Enter upper limit of this weight band in kg. The lower limit will be determined by the other weight bands.',
                    max_digits=12)),
        ...
        migrations.AddField(
            ...
            name='method',
            field=models.ForeignKey(verbose_name='Method',
                                    related_name='bands',
